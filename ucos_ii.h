...
#define PTHREAD_DEFAULT_SLICE          10u
#define PTHREAD_CREATE_JOINABLE        0U
#define PTHREAD_CREATE_DETACHED        1U
#define PTHREAD_DEFAULT_STACK_SIZE     2048U
#define PTHREAD_DEFAULT_GUARD_SIZE     256U
#define PTHREAD_DEFAULT_PRIORITY       30U
#define PTHREAD_NAME_MAX_LEN           16U

#define pthread_flase                  0u
...
#error  "OS_CFG.H, Missing OS_TIME_DLY_HMSM_EN: Include code for sleep()"
#endif
